...
"i686-linux-thread-multi-2.6.17-1.2142_fc4" or
	die "Errno architecture (i686-linux-thread-multi-2.6.17-1.2142_fc4) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
