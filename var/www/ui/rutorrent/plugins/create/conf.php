<?php
	...
	$pathToCreatetorrent = '/usr/bin/rtorrent/bin/mktorrent';		// Something like /bin/createtorrent, or /bin/transmissioncli. If empty, program will be found in PATH.
	$pathToExternals["pgrep"] = '/usr/bin/rtorrent/bin/pgrep';		// Something like /usr/bin/pgrep. If empty, will be found in PATH.
