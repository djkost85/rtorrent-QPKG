...
$pathToExternals['sox'] = '/usr/bin/rtorrent/bin/sox';		// Something like /usr/bin/sox. If empty, will be found in PATH.

$extensions = array
(
	"8svx", "aif", "aifc", "aiff", "aiffc", "al", "amb", "au", "avr", "caf", "cdda", "cdr", "cvs", "cvsd", 
	"cvu", "dat", "dvms", "f32", "f4", "f64", "f8", "fap", "flac", "fssd", "gsm", "gsrt", "hcom", "htk", 
	"ima", "ircam", "la", "lpc", "lpc10", "lu", "mat", "mat4", "mat5", "maud", "nist", "paf", "prc", "pvf", 
